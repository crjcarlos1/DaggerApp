...
public class PostsViewModel extends ViewModel {
    public static final String TAG = PostsViewModel.class.getSimpleName();
    ...
    public PostsViewModel(SessionManager sessionManager, MainApi mainApi) {
        ...
        Log.e(TAG, "PostsViewModel: viewModel posts is ready!");
    }
    ...
    public LiveData<Resource<List<Post>>> observePosts(){
        if (posts==null){
            ...
            final  LiveData<Resource<List<Post>>> source = LiveDataReactiveStreams.fromPublisher(           /**hacemos el request a la Api*/
